...
best_score = 0
for M in range(2, 15, 2):
    for ab in [0.0001, 0.001, 0.01, 0.1, 1]:
        boostModel = AdaBoostClassifier(n_estimators=M, learning_rate=ab, random_state=0)
        ...
        if score > best_score:
            ...
            best_ =M
            best_ab = ab
SelectedBoostModel = AdaBoostClassifier(n_estimators=M, learning_rate=ab, random_state=0).fit(X_train_scaled, Y_train)
...
print("best parameter of LR is: ", best_ab)
