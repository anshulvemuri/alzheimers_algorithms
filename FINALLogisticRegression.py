...
# Create a LogisticRegressionModel and fit it with training dataset
SelectedLogRegModel = LogisticRegression(C=1).fit(X_train, Y_train)
...
y_predicted = SelectedLogRegModel.predict(x_predict)
if y_predicted[0] == 0:
